...
#SBATCH --job-name=p03125_SpinUp_2
...
## Copy restart files
cp $SCRATCH/NW2_TracerBackscatter/p03125_SpinUp_2_restarts/MOM.res.nc INPUT
cp $SCRATCH/NW2_TracerBackscatter/p03125_SpinUp_2_restarts/MOM.res_1.nc INPUT
cp $SCRATCH/NW2_TracerBackscatter/p03125_SpinUp_2_restarts/MOM.res_2.nc INPUT
cp $SCRATCH/NW2_TracerBackscatter/p03125_SpinUp_2_restarts/MOM.res_3.nc INPUT
cp $SCRATCH/NW2_TracerBackscatter/p03125_SpinUp_2_restarts/MOM.res_4.nc INPUT
